        ...
        var info = {
            ...
            comment: function (args) {
                ...
                if (userId == "" || userId == null) {
                    html += '<button class="button disable" disable="disable">评论</button>'
                } else {
                ...
                for (var i = 0; i < list.length; i++) {
                    ...
                    var replyList = list[i][commentMapping.replyInfoLsit];
                    if (userId == "" || userId == null) {
                    } else {
            ...
            javaexComment: function (obj, args) {
                ...
                if (content == "") {
                    info.optTip({content: "评论内容不能为空", type: "error"});
                    return
                }
                opt.callback({"type": "comment", "content": content})
            },
            ...
            score: function (args) {
                ...
                var liHtml = '';
                for (var i = 1; i <= num; i++) {
                    liHtml += '<li index="' + i + '" score="' + scoreArr[i - 1] + '"><i class="star icon-star_border"></i></li>'
                }
                ...
                if (!isReadOnly) {
                    ...
                    $("#" + id + " li").click(function () {
                        ...
                        opt.callback({"index": index, "score": $(this).attr("score")})
                    })
                }
            },
            progress: function () {
                $(".progress").each(function () {
                    $(this).find(".progress-bar").animate({width: $(this).attr("data-percent")}, 1000)
                })
            },
            ...
            optTip: function (args) {
                ...
                if (type == "submit") {
                    ...
                    if ($(".tip-icon-loading").length > 0) {
                        ...
                        $(".opt-tip .tip-icon").css({"font-size": "16px", "font-weight": "bold"});
                    ...
                    if ($(".tip-icon-loading").length > 0) {
                        ...
                        $(".opt-tip .tip-icon").removeClass("tip-icon-loading");
                        $(".opt-tip .tip-icon").addClass("icon-x");
                        $(".opt-tip .tip-icon").css({"font-size": "16px", "font-weight": "bold"});
                        $(".opt-tip .tip-msg").text(opt.content)
                    } else {
                        $(".opt-tip").remove();
                        ...
                        tipHtml += '<div style="display: flex;">';
                        tipHtml += '<span class="tip-icon icon-x" style="font-size:16px; font-weight:bold;"></span>';
                        tipHtml += '<span class="tip-msg">' + opt.content + '</span>';
                        tipHtml += '</div>';
                        tipHtml += '</div>'
                    }
            ...
            loading: function (args) {
                ...
                if (opt.isIcon) {
                    if (content == "") {
                        $(document.body).append('<div id="loading">正在读取数据，请稍候...</div>')
                    } else {
                        $(document.body).append('<div id="loading">' + content + '</div>')
                    }
                } else {
                    $(document.body).append('<div id="loading" style="display:none;">正在读取数据，请稍候...</div>')
                }
            ...
            dialog: function (args) {
                ...
                if (type == "image") {
                    ...
                    dialogHtml += '<a class="last-next-image last" href="javascript:;"><span title="上一张" onclick="javaex.lastImg(\'' + UUID + '\', \'' + selector + '\');"></span></a>';
                    dialogHtml += '<a class="last-next-image next" href="javascript:;"><span title="下一张" onclick="javaex.nextImg(\'' + UUID + '\', \'' + selector + '\');"></span></a>';
                    dialogHtml += '</div>';
                    dialogHtml += '<a class="close2" href="javascript:;" onclick="javaex.close(\'' + UUID + '\');"></a>';
                    dialogHtml += '</div>'
                } else if (type == "login") {
                    dialogHtml += '<div class="mask" style="background:none;"></div>';
                    dialogHtml = '<div id=' + UUID + ' class="dialog animated zoomIn" style="width:' + width + 'px;left:' + (document.documentElement.clientWidth - width) / 2 + 'px;">';
                ...
                if (mode == "mouseover") {
                    $("#" + tabId + " .tab-title ul li").mouseover(function () {
                        ...
                        setTimeout(function () {
                            ...
                            opt.callback({"index": $this.index() + 1})
                        }, opt.delay)
                    })
                } else if (mode == "click") {
            ...
            select: function (args) {
                ...
                if ($("#" + selectId).hasClass("no-shadow")) {
                    $("#input-" + selectId).addClass("no-shadow")
                }
                ...
                $("#span-" + selectId).click(function (event) {
                    if ($("#" + selectId).prop("disabled")) {
                        ...
                        $(this).find("ul").css({"width": $(this).find("input").width() + 22, "display": "block"});
                ...
                $("#ul-" + selectId + " option").on("click", function (event) {
                    ...
                    opt.callback({"selectValue": selectValue, "selectName": selectName});
                    event.stopPropagation()
                });
                ...
                function init(pageId) {
                    $("#" + pageId).children("li").click(function () {
                        ...
                        if (currentPage != "" && currentPage != lastPage) {
                            opt.callback({"pageNum": currentPage})
                        }
                    })
                }
            ...
            date: function (args) {
                ...
                function fillDate(year, month, index) {
                    ...
                    if (index == 0) {
                        if (monthNum == 1 && (isTime || isTime == "true")) {
                            $(td).append('<a href="javascript:void(0);" id="next-month-' + dateId + '"><span class="icon-chevron-right2" style="position: absolute;top: 10px;right: 22px;color: #555;font-size: 14px;"></span></a>');
                            $(td).append('<a href="javascript:void(0);" id="next-year-' + dateId + '"><span class="icon-next" style="position: absolute;top: 6px;right: 0;color: #555;font-size: 20px;"></span></a>')
                        } else {
                    ...
                    if ((index + 1) == monthNum) {
                        if (monthNum == 1 && (isTime || isTime == "true")) {
                            $(td).append('<a href="javascript:void(0);" id="last-year-' + dateId + '"><span class="icon-previous" style="position: absolute;top: 6px;left: 0;color: #555;font-size: 20px;"></span></a>');
                            $(td).append('<a href="javascript:void(0);" id="last-month-' + dateId + '"><span class="icon-chevron-left2" style="position: absolute;top: 10px;left: 22px;color: #555;font-size: 14px;"></span></a>')
                        } else {
            ...
            time: function (args) {
                ...
                timeHtml += '</table>';
                timeHtml += '</div>';
                timeHtml += '<div class="date-foot date-ui">';
                ...
                if (type == "image") {
                    $("#" + inputId).change(function () {
                        ...
                        if (!/\.(gif|jpg|jpeg|png|GIF|JPG|PNG)$/.test(imageFile.name)) {
                            info.optTip({content: "图片类型必须是.gif,jpeg,jpg,png中的一种", type: "error"});
                            return false
                        }
                        if (maxSize == "" || maxSize == 0 || maxSize == "0") {
                        } else {
                            if (imageFile.size > (maxSize * 1024)) {
                                info.optTip({content: "图片过大，单张图片上限 " + maxSize + "KB", type: "error"});
                                return false
                            }
                        }
                        if (dataType == "base64") {
                            ...
                            info.optTip({content: "文件上传中，请稍候...", type: "submit"});
                            $.ajax({
                                url: url,
                                type: "post",
                                data: data,
                                ...
                                success: function (rtn) {
                                    info.optTip({content: "上传成功", type: "success", live: 1000});
                                    opt.callback(rtn)
                                },
                                error: function () {
                                    info.optTip({content: "上传失败，请稍后重试", type: "error"})
                                }
                            })
                        }
                    })
                    ...
                    $("#" + inputId).change(function () {
                        if ($("#" + containerId + " img").length > (parseInt(maxNum) - 1)) {
                            info.optTip({content: "最多上传" + maxNum + "张图片", type: "error"});
                            return false
                        }
                        if (dataType == "base64") {
                            var uuidArr = new Array();
            ...
            edit: function (args) {
                ...
                if (image == null || image.dataType == "base64") {
                    info.upload({
                        type: "image", id: UUID, dataType: "base64", callback: function (rtn) {
                            restoreSelection();
