...
<style>
	.login-bg{width: 100%;min-height: 600px;height: calc(100vh - 100px - 100px);background-image: url("http://img.hb.aicdn.com/6b481c6f882f41c89dfc825ee156907dc7ec55c23f431-unhudX_fw658");background-size: auto 100%;background-position: 45% center;background-repeat: no-repeat;position: relative;}
		...
		if (javaexVerify()) {
			$.ajax({
				...
				success : function(rtn) {
					if (rtn.code=="000000") {
						// 跳转到后台首页
						window.location.href = "${pageContext.request.contextPath}/type_info/list.action";
					} else {
