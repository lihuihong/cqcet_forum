						...
						<div class="main-20">
							...
							<div class="operation-wrap">
								<div class="buttons-wrap">
									<a href="${pageContext.request.contextPath}/admin/edit.action">
										...
										<c:otherwise>
											<c:forEach items="${pageInfo.list}" var="entity" varStatus="status" >
												<tr>
													...
													<td>${entity.title}</td>
													<td>
														<a href="${pageContext.request.contextPath}/admin/user_article.action?userId=${entity.userId}">
															<button class="button green">${entity.username}</button>
													</a>
													</td>
													<td><fmt:formatDate value="${entity.updateTime}" pattern="yyyy/MM/dd  HH:mm:ss" /></td>
													<td>${entity.viewCount}</td>
													<td>
														<a href="${pageContext.request.contextPath}/admin/edit.action?id=${entity.id}">
