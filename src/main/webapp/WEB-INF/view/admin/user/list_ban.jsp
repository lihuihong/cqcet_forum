				...
				<div class="main">
					...
					<div class="operation-wrap">
						<div class="buttons-wrap">
							<button id="recovery" class="button green"><span class="icon-check2"></span> 批量解禁</button>
						</div>
					</div>
					...
					<div class="block no-shadow">
						<!--banner用来修饰块元素的名称-->
						<div class="banner">
							<p class="tab fixed">清空该用户相关内容</p>
						</div>
						<!--正文内容-->
						<div class="main-8">
							<input type="checkbox" class="fill listen-2" />全选
							<ul class="equal-8">
								<li><input type="checkbox" class="fill listen-2-2" name="delete" value="thread" />帖子</li>
								<span class="clearfix"></span>
							</ul>
							<button id="save" class="button red" style="margin-top:20px;"><span class="icon-check2"></span> 提交</button>
						</div>
					</div>
				</div>
			</div>
