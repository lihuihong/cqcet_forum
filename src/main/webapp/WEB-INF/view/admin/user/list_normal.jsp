				...
				<div class="main">
					...
					<div class="block no-shadow">
						...
						<div class="main" style="margin-bottom:100px;">
							<p class="tip warning">会员用户组会根据积分自动变更</p>
							<input type="radio" class="fill" name="radio" value="change_group" />批量移动到用户组
							<select id="group_id2">
								<c:forEach items="${gradeList}" var="groupInfo" varStatus="status" >
							...
							<br />
							<input type="radio" class="fill" name="radio" value="ban" />批量封禁
							<br />
