                        ...
                        <table id="table" class="table">
                            ...
                            <c:forEach items="${list}" var="entity" varStatus="status">
                                <tr>
                                    ...
                                    <td><input type="text" class="text" name="name" data-type="必填" placeholder="请输入学院"
                                               value="${entity.name}"/></td>
                                    <td><input type="text" class="text" name="sort" data-type="必填"
                                               placeholder="请输入优先级" value="${entity.sort}"/></td>
...
<script>
    ...
    $("#add").click(function () {
        ...
        html += '<td><input type="text" class="text" name="name" data-type="必填" placeholder="请输入学院" value="" /></td>';
