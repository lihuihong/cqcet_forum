...
<!--核心样式-->
<link href="http://cdn.javaex.cn/javaex/pc/css/style.css" rel="stylesheet" />
			...
			<div class="grid-1-2-1">
				...
				<div id="main-content" style="min-width: 950px;margin-top: 50px;margin-bottom: 40px;">
					...
					<div class="block block2">
						<div class="main-0" style="margin: 20px">
							<p>2016-09-01：</p>
							<blockquote><p style="margin-left: 10px">就读于重庆电子工程职业学院软件学院</p></blockquote>
							
						</div>
						<div class="main-0" style="margin: 20px">
							<p>2016-09-01 ～ 2017-06 底：</p>
							<blockquote><p style="margin-left: 10px">Android</p></blockquote>
							<blockquote><p style="margin-left: 10px">Java</p></blockquote>
							<blockquote><p style="margin-left: 10px">Node</p></blockquote>
							<blockquote><p style="margin-left: 10px">会一点点前端</p></blockquote>
						</div>
						
						<div class="main-0" style="margin: 20px">
							<p>个人网站和GitHub</p>
							<blockquote><a style="margin-left: 10px" href="https://github.com/lihuihong"><span class="icon-tags">GitHub</span></a></blockquote>
							<blockquote><a style="margin-left: 10px" href="https:www.heylhh.top"><span class="icon-tags">个人网站</span></a></blockquote>
