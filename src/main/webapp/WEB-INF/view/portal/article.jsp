			...
			<div class="grid-1-2-1">
				...
				<div id="main-content" style="min-width: 950px;margin-top: 100px;margin-bottom: 40px;">
					<div class="content-header">
						...
						<span class="active"><a style="color: rgb(0, 153, 153);" href="${pageContext.request.contextPath}/portal/type.action?typeId=${articleInfo.typeId}">${articleInfo.name}</a></span>
						<span class="divider">/</span>
						<span>${articleInfo.title}</span>
						<p>浏览量：${articleInfo.viewCount}</p>
					</div>
					
					<div class="block block2">
						<div class="main-0" style="margin: 10px">
